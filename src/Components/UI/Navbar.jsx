...
const NavBar = ({ search }) => {
    ...
    return (
        <nav className="bg-indigo-900/95 backdrop-blur-lg shadow-lg z-40 fixed w-full top-0">
            <div className="max-w-7xl mx-auto px-8">
                <div className="flex items-center justify-between py-2">
                    ...
                    <div className="-mr-2 flex md:hidden">
                        <button onClick={() => setMinimize(!minimize)} className="text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
            ...
            <div className={`md:hidden duration-300 px-2 pt-2 pb-3 space-y-1 sm:px-3 overflow-hidden ${minimize ? '!h-0 !py-0' : 'h-32'}`}>
